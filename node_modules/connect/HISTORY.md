...
==================
  ...
  * Added public `res.headerSent` checking nodes `res.getHeaders()ent` until node does
...
==================
  ...
  * Added public `res.headerSent` checking nodes `res.getHeaders()ent` (remove when node adds this)
...
==================
  ...
  * Fixed `res.getHeaders()` logger regression. Closes #318
